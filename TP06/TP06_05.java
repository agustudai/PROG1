...
public class TP06_05 {
    ...
    public static void procesar(int[][] mat){
        ...
        while((fila < N) && !continuar){
            continuar = eliminar_num(mat[fila],numero);
            fila++;
        }
    }

    public static boolean eliminar_num(int[] mat,int numero){
    ...
    public static void correr_izq(int[]mat,int pos){
        int indice = M-1;
        while(pos < indice){
            mat[pos] = mat[++pos];
        }
